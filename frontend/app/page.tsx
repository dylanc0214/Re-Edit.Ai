...
export default function Home() {
  ...
  // ------------------------------------------------------------------
  // --- CSS PARSING LOGIC (Unchanged from your last fix) ---
  // ------------------------------------------------------------------
  const parseAllStyles = (cssString: string, htmlString: string): {
    ...
    console.log('--- STARTING CSS PARSE (CSS file + Inline) ---');
    ...
    // Upgraded Regex to find hex, rgb, rgba, hsl, AND hsla
  ...
  // ------------------------------------------------------------------
  // HANDLE SCRAPE
  // (This is unchanged from your last fix)
  // ------------------------------------------------------------------
  ...
  // ------------------------------------------------------------------
  // RENDER UI
  // --- This is the same code as before (with Upload Files) ---
  // ------------------------------------------------------------------
  return (
